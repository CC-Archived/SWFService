...
// Generated by CoffeeScript 1.4.0
(function() {
  var DeferredEntityRegistry, EntitySet, SWFService, SWFServiceContext, SWFServiceContextManager, SWFServiceEventListenerProxy, SWFServiceOperationProxy, SWFServiceProxy, target;
  ...
  DeferredEntityRegistry = (function() {
    ...
    function DeferredEntityRegistry(entityClass, entityKeyProperty, options) {
      this.entityClass = entityClass;
      this.entityKeyProperty = entityKeyProperty != null ? entityKeyProperty : 'id';
    ...
    DeferredEntityRegistry.prototype.get = function(entityId) {
  ...
  SWFServiceContext = (function() {
    ...
    SWFServiceContext.prototype.get = function(serviceId) {
      return this.serviceProxyRegistry.get(serviceId);
    };
  ...
  SWFServiceContextManager = (function() {
    ...
    SWFServiceContextManager.prototype.getBySWF = function(swf) {
      var deferred, intervalId,
        _this = this;
      deferred = new Deferred();
  ...
  SWFService = (function() {
    ...
    SWFService.prototype.get = function(swf, serviceId) {
      return this.serviceContextManager.getBySWF(swf).then(function(serviceContext) {
